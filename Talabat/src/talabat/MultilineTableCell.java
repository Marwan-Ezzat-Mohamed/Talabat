    ...
    class CellArea extends DefaultTableCellRenderer {
        ...
        public void paintComponent(Graphics gr) {
            ...
            if (text != null && !text.isEmpty()) {
                ...
                table.getColumnModel().getColumn(6).setMaxWidth(Math.max((int) drawPosY,160));
                table.getColumnModel().getColumn(6).setMinWidth(Math.max((int) drawPosY,160));
